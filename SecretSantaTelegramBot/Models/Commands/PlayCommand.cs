...
"После тайной жеребьевки тебе определится человек, которому ты должен отдать подарок." +
$"Жеребьёвка начнется {secretSantaGame.EndDate:HH:mm dd.MM.yyyy}. Не забудь приготовить подарок🎁", ParseMode.Markdown);
        }
    }
}
